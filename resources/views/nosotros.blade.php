...
@section('content')
    ...
    <section id="first">
        <div class="container text-center bg-dark rounded shadow my-4 p-3">
            ...
            <div class="row mt-30">
                <div class="col-md-4 col-sm-6">
                    <div class="box5">
                        <img src="http://bestjquery.com/tutorial/hover-effect/demo160/images/img-1.jpg" alt="">
                        <ul class="icon">
       ...
       <div class="container mt-40">
            <h3 class="text-center">Presentación efecto 4</h3>
            <div class="row mt-30">
                <div class="col-md-4 col-sm-6">
                    <div class="box7">
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="box7">
                        <img src="http://bestjquery.com/tutorial/hover-effect/demo156/images/img-2.jpg" alt="">
                        <div class="box-content">
                            <h3 class="title">Axel Jerez</h3>
                            <span class="post">Web Designer</span>
                            <ul class="icon">
